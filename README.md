...
- Effective Lines Drawing 
- 3D Preview 
- Offset Table
- Hydrostatic Calculation
- Resistance Calculation using Holtrop Mennen Method
- .json save file


## 🚀 Run the Application
We named the file as "training" since this project is to learn and develop Jalayn as a free software to help Naval Architect.
We also have two samples of lines inside the sample folder.
